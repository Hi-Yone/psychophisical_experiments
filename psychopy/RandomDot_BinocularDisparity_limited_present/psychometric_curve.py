...
TestDisk_radius_arr = [1.383, 1.707, 2.181, 2.475, 3, 3.507, 4.0200000000000005, 4.59, 5.223000000000001]
...
selection_prop[0][7] = 1
selection_prop[1][7] = 1
selection_prop[2][7] = 1
selection_prop[3][7] = 1
selection_prop[4][7] = 1
...
y_fit_3 = gauss(xx, y_fit_param_list[3][0], y_fit_param_list[3][1])
y_fit_4 = gauss(xx, y_fit_param_list[4][0], y_fit_param_list[4][1])
...
# plt.scatter(TestDisk_radius_arr, selection_prop[1], color='none', marker='^', s=100, edgecolors='red')
# plt.plot(xx, y_fit_1, color='red', linestyle='dotted', label=' - 0.15°',linewidth=3)
plt.scatter(TestDisk_radius_arr, selection_prop[2], color='black', s=100)
plt.plot(xx, y_fit_2, color='black', label='0°',linewidth=3)
# plt.scatter(TestDisk_radius_arr, selection_prop[3], color='none', marker=',', s=100, edgecolors='blue')
# plt.plot(xx, y_fit_3, color='blue', linestyle='dotted', label=' 0.15°',linewidth=3)
plt.scatter(TestDisk_radius_arr, selection_prop[4], color='blue', marker=',', s=100)
plt.plot(xx, y_fit_4, color='blue', linestyle='dashed', label=' 0.3°',linewidth=3)
...
plt.xticks(TestDisk_radius_arr, relative_rr, fontsize=16)
...
plt.plot(disparity, measuredAngle, color='red', label='mesured')
...
plt.xticks(disparity, fontsize=16); plt.yticks(yaxis_angle, np.round(yaxis_angle/6, 2), fontsize=16)
