...
for trial in trials:
    ...
    if TestPos_LorR == 'left':
        # 円形のパッチ刺激
        LeyeStim_left = visual.Circle(win, units='deg', radius=TestDisk_radius, fillColor='white', pos=LeyeStim_left_centerPos+(disparity_test, 0))
        LeyeStim_right = visual.Circle(win, units='deg', radius=RefDisk_radius, fillColor='white', pos=LeyeStim_right_centerPos)
    
        ReyeStim_left = visual.Circle(win, units='deg', radius=TestDisk_radius, fillColor='white', pos=ReyeStim_left_centerPos-(disparity_test, 0))
        ReyeStim_right = visual.Circle(win, units='deg', radius=RefDisk_radius, fillColor='white', pos=ReyeStim_right_centerPos)

    # test刺激が固視点の右に呈示される条件
    else:
        # 円形のパッチ刺激
        LeyeStim_left = visual.Circle(win, units='deg', radius=RefDisk_radius, fillColor='white', pos=LeyeStim_left_centerPos)
        LeyeStim_right = visual.Circle(win, units='deg', radius=TestDisk_radius, fillColor='white', pos=LeyeStim_right_centerPos-(disparity_test, 0))
    
        ReyeStim_left = visual.Circle(win, units='deg', radius=RefDisk_radius, fillColor='white', pos=ReyeStim_left_centerPos)
        ReyeStim_right = visual.Circle(win, units='deg', radius=TestDisk_radius, fillColor='white', pos=ReyeStim_right_centerPos+(disparity_test, 0))
