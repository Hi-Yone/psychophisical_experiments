...
print(corrStim_Leye_ref.nElements)
corrStim_Leye_ref.nElements = len(pos_dots[select_range_Ref])  # ドット数 (ドット数は変更できないので、毎回同じドット数が表示される)
corrStim_Leye_ref.setXYs(corr_dots_Leye_ref)               # ドット位置
corrStim_Reye_ref.nElements = len(pos_dots[select_range_Ref])  # ドット数 (ドット数は変更できないので、毎回同じドット数が表示される)
...
corrStim_Leye_test.nElements = len(pos_dots[select_range_Test])  # ドット数 (ドット数は変更できないので、毎回同じドット数が表示される)
corrStim_Leye_test.setXYs(corr_dots_Leye_test)               # ドット位置
corrStim_Reye_test.nElements = len(pos_dots[select_range_Test])  # ドット数 (ドット数は変更できないので、毎回同じドット数が表示される)
