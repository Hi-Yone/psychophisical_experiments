...
# 刺激生成クラス
stim_gene = stim.stim_generator(framerate=MONITOR_FRAMERATE, 
...
disparity_arr = [-0.45, 0, 0.45]                                                                     # 刺激の視差リスト
...
stim_start = 2                                                                                                  # 刺激開始時刻                                                                                           # 刺激呈示時間
present_time = 0.282                                                                                            # 刺激呈示時間
resp_start = stim_start+present_time                                                                            # 応答開始時間
flip_interval = 6                                                                                               # フリップ間隔

# =========================================================
# 実験条件
# =========================================================
N_repeat = 5                                                                                                   # 各パラメータの繰り返し回数
...
for trial in trials:
    ...
    pattern_num = int(MONITOR_FRAMERATE/flip_interval*present_time) + 3
    print('monitor frame rate : ', MONITOR_FRAMERATE, 'Hz, pattern num : ', pattern_num)
    print('実際に呈示される枚数 : ', int(MONITOR_FRAMERATE/flip_interval*present_time))
    for __ in range(pattern_num):
        # =========================================================
        # 実験刺激の生成
        # =========================================================
