...
TestDisk_radius_arr = np.array([0.727, 1, 1.340]) * RefDisk_radius                                # test刺激の半径
# TestDisk_radius_arr = np.array([0.49, 0.727, 1, 1.340, 1.7]) * RefDisk_radius                                # test刺激の半径
